...
(function () {
  var d = Arcade.i18n.dicts;
      ...
      /* 人物（占位；生平/金句由内容批产出） */
      var zhP = { champollion: ['商博良', '🧱'], caesar: ['凯撒', '🏛️'], kindi: ['肯迪', '🌙'], bacon: ['培根', '🖋️'], vigenere: ['维吉尼亚', '🔑'], payne: ['乔治·佩恩万', '🪖'], turing: ['图灵', '⚙️'], welchman: ['韦尔奇曼', '🧩'], friedman: ['弗里德曼', '🈁'], flowers: ['弗劳尔斯', '💡'], shannon: ['香农', '📐'], rosenberg: ['罗森伯格夫妇', '🕊️'] };
      var enP = { champollion: ['Champollion', '🧱'], caesar: ['Caesar', '🏛️'], kindi: ['Al-Kindi', '🌙'], bacon: ['Bacon', '🖋️'], vigenere: ['Vigenère', '🔑'], payne: ['Georges Painvin', '🪖'], turing: ['Turing', '⚙️'], welchman: ['Welchman', '🧩'], friedman: ['Friedman', '🈁'], flowers: ['Flowers', '💡'], shannon: ['Shannon', '📐'], rosenberg: ['The Rosenbergs', '🕊️'] };
      for (var pid in zhP) {
        d.zh['stp.' + pid + '.name'] = zhP[pid][0];
        d.en['stp.' + pid + '.name'] = enP[pid][0];
        d.zh['stp.' + pid + '.icon'] = zhP[pid][1];
        d.en['stp.' + pid + '.icon'] = enP[pid][1];
        d.zh['stp.' + pid + '.role'] = '（档案完善中）';
        d.en['stp.' + pid + '.role'] = '(profile coming soon)';
        d.zh['stp.' + pid + '.era'] = '—';
        d.en['stp.' + pid + '.era'] = '—';
        d.zh['stp.' + pid + '.bio'] = '—';
        d.en['stp.' + pid + '.bio'] = '—';
...
(function () {
  ...
  dd.zh['stp.wangxy.fact'] = '2004 年美密会（Crypto 2004）上，王小云团队宣布攻破 MD5 时全场起立鼓掌；与会者当场改写论文结论。此后她的团队又拿下 SHA-1 的理论碰撞，直接催生了 SHA-3 竞赛加速与全球哈希算法迁移。';
  ...
  dd.zh['stp.gardner.era'] = '1912–2002 · 美国'; dd.en['stp.gardner.era'] = '1912–2002 · United States';
  ...
  dd.zh['stp.clarke.era'] = '1917–1996 · 英国'; dd.en['stp.clarke.era'] = '1917–1996 · United Kingdom';
  ...
  dd.zh['stp.alberti.era'] = '1404–1472 · 意大利'; dd.en['stp.alberti.era'] = '1404–1472 · Italy';
  ...
  dd.zh['stp.cardano.era'] = '1501–1576 · 意大利'; dd.en['stp.cardano.era'] = '1501–1576 · Italy';
  ...
  dd.zh['stp.rijmen.era'] = '1975– · 比利时'; dd.en['stp.rijmen.era'] = '1975– · Belgium';
  dd.zh['stp.rijmen.fact'] = '他与合作者 Daemen 的 Rijndael 从 15 个候选中胜出成为 AES（FIPS 197，2001）——设计文档公开、免专利费，如今保护着从手机到卫星的一切。';
  ...
  dd.zh['stp.elgamal.era'] = '1955–2022 · 埃及/美国'; dd.en['stp.elgamal.era'] = '1955–2022 · Egypt/USA';
  ...
  dd.zh['stp.miller.era'] = '1947– · 美国'; dd.en['stp.miller.era'] = '1947– · United States';
  ...
  dd.zh['stp.back.era'] = '1970– · 英国/马耳他'; dd.en['stp.back.era'] = '1970– · UK/Malta';
