...
(function () {
  ...
  d.zh['st.next'] = '下一章';
  d.en['st.next'] = 'next';
  /* 叙事评审 Top3：每章「下章预告」钩子（st.cN.next，c10 无下章不渲染） */
  ...
  d.zh['st.c0.tldr'] = '一块石碑三种文字，让人类第一次读懂了消失五千年的古埃及文明——这就是「破译」的力量。';
...
(function () {
  var d = Arcade.i18n.dicts;
  d.zh['st.c1.facts'] = '凯撒密码其实没有固定偏移。苏埃托尼乌斯记载，凯撒本人只把字母后移三位，但他的侄子奥古斯都用的却是「把 A 当 B」的移位。而西塞罗在《书信集》中更早地提及换位密码，与斯巴达「密码棒」同源——可见移位与换位之争，两千年前就开始了。';
...
(function () {
  ...
  d.zh['st.c11.facts'] = '「墨子号」2017 年实现星地量子密钥分发，把 BB84 从光纤搬上太空，北京与维也纳曾借此完成跨洲量子加密视频通话。另一条：谷歌已在 Chrome 中试水「混合密钥交换」，让传统椭圆曲线与后量子 Kyber 并肩护航——迁移不是换闸刀，而是先让两把锁同门站岗。';
