  ...
  function render() {
    ...
    var CARDS = [
      ...
      { ic: '👤', n: N('PEOPLE'), t: L({ zh: '人物志', en: 'People' }),
        d: L({ zh: '八十七位破译与造码者的时间线：生平、冷知识、名言与传记出处，一图看清三千年棋手。', en: 'Eighty-seven codebreakers and cipher-makers on one timeline — bios, facts, quotes, sources.' }),
        href: 'people.html', mini: L({ zh: '时间线 · 人物档案 · 关系图', en: 'Timeline · profiles · relationship map' }) },
      { ic: '📎', n: N('ARTIFACTS'), t: L({ zh: '密件册', en: 'Artifacts' }),
        d: L({ zh: '四十六件改变历史的原件与档案：破解对应游戏即可解锁全文，馆藏出处一应俱全。', en: 'Forty-six originals and archives that changed history: unlock each with its game, sources included.' }),
      ...
      { ic: '🛡️', n: null, t: L({ zh: '协议实验室', en: 'Protocol Lab' }),
        d: L({ zh: '十八个可以上手的现代密码学演示：TLS 握手、DH 中间人、OTP 复用灾难、DH 参数验证……', en: 'Eighteen hands-on modern crypto demos: TLS handshake, DH MITM, OTP reuse, DH parameter checks…' }),
      ...
      { ic: '🧠', n: null, t: L({ zh: '测验场', en: 'Quiz' }),
        ...
        href: 'quiz.html', mini: L({ zh: '二百四十题 · 8 段位 · 错题回顾', en: '240 questions · 8 ranks · wrong review' }) },
      { ic: '🗺️', n: null, t: L({ zh: '世界地图', en: 'World Map' }),
        ...
        href: 'map.html', mini: L({ zh: '63 个坐标 · 章节联动', en: '63 coordinates · chapter links' }) },
      ...
      { ic: '📊', n: null, t: L({ zh: '档案页', en: 'Profile' }),
        ...
        href: 'stats.html', mini: L({ zh: '成就 28 枚 · 全部本地记录', en: '28 achievements · all local' }) }
    ];
