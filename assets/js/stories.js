...
Arcade.stories = (function () {
  ...
  window.STORIES = [
    ...
    { id: 'quantum', era: 'era11', titleKey: 'st.c11.t', bodyKey: 'st.c11.b', people: ['wiesner', 'bennett', 'brassard', 'shor', 'grover'], games: ['bb84', 'qkd-sim'], core: ['bb84'], artifact: 'qmoney', prev: 'modern', next: null, funFacts: true, challenge: 'qber', demo: 'bb84', concept: { ic: '⚛️', zh: '量子威胁与后量子：Shor 瓦解公钥，格密码与 QKD 重筑防线', en: 'Quantum threat & post-quantum: Shor breaks public key; lattices and QKD rebuild the walls' },
