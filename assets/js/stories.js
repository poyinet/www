...
Arcade.stories = (function () {
  ...
  window.STORIES = [
    ...
    { id: 'modern', era: 'era10', titleKey: 'st.c10.t', bodyKey: 'st.c10.b', people: ['shannon', 'diffie', 'shamir', 'adleman', 'merkle', 'cocks', 'ellis', 'feistel', 'rivest', 'hellman', 'pzimmermann', 'schneier', 'daemen', 'wangxy', 'rijmen', 'elgamal', 'miller', 'back'], games: ['xor', 'hill', 'base64', 'binary', 'maker', 'codeguess', 'circuit', 'lightsout', 'maze', 'pipe', 'puzzle15', 'hashi', 'klotski', 'hashlab', 'solitaire', 'rsa', 'shamir', 'sm4', 'phishhunt', 'aes-lab', 'password-vault', 'pgp-mail', 'blockchain-miner', 'totp-verify'], core: ['xor', 'hill', 'base64', 'maker', 'hashlab'], letter: { cipher: 'hill', keyLetter: 'R', answer: 'RING THEORY WINS'}, artifact: 'shannon', prev: 'venona', next: 'quantum', funFacts: true, challenge: 'hill-mat', demo: 'entropy', concept: { ic: '🔐', zh: '信息论与公钥：熵、完美保密、异或原子与 RSA', en: 'Information theory & public key: entropy, secrecy, XOR, RSA' },
