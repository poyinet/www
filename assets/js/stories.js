...
Arcade.stories = (function () {
  ...
  window.STORIES = [
    ...
    { id: 'purple', era: 'era7', titleKey: 'st.c7.t', bodyKey: 'st.c7.b', people: ['friedman', 'efriedman'], games: ['purple', 'codebreak', 'morse', 'gomoku', 'reversi', 'fourline', 'intel-assess'], core: ['purple', 'codebreak'], letter: { cipher: 'affine', keyLetter: 'A', answer: 'ATTACK COMING EASTWARD'}, artifact: 'eastwind', prev: 'midway', next: 'lorenz', funFacts: true, challenge: 'purple-vowels', demo: 'purple', concept: { ic: '🇯🇵', zh: '步进开关机：无转子，开关矩阵做双路置换', en: 'Stepping-switch machine: no rotors, matrix twin-path permutation' },
    ...
    'koblitz', 'goldwasser', 'micali', 'rackoff', 'gentry', 'chaum', 'bernstein', 'matsui', 'biham'], games: ['xor', 'hill', 'base64', 'binary', 'maker', 'codeguess', 'circuit', 'lightsout', 'maze', 'pipe', 'puzzle15', 'hashi', 'klotski', 'hashlab', 'solitaire', 'rsa', 'shamir', 'sm4', 'phishhunt', 'aes-lab', 'password-vault', 'pgp-mail', 'blockchain-miner', 'totp-verify', 'side-channel-lab', 'homomorphic-lab'], core: ['xor', 'hill', 'base64', 'maker', 'hashlab'], letter: { cipher: 'hill', keyLetter: 'R', answer: 'RING THEORY WINS'}, artifact: 'shannon', prev: 'venona', next: 'quantum', funFacts: true, challenge: 'hill-mat', demo: 'entropy', concept: { ic: '🔐', zh: '信息论与公钥：熵、完美保密、异或原子与 RSA', en: 'Information theory & public key: entropy, secrecy, XOR, RSA' },
    ...
    { id: 'quantum', era: 'era11', titleKey: 'st.c11.t', bodyKey: 'st.c11.b', people: ['wiesner', 'bennett', 'brassard', 'shor', 'grover'], games: ['bb84', 'qkd-sim', 'pqc-match', 'zkp-cave'], core: ['bb84'], artifact: 'qmoney', prev: 'modern', next: null, funFacts: true, challenge: 'qber', demo: 'bb84', concept: { ic: '⚛️', zh: '量子威胁与后量子：Shor 瓦解公钥，格密码与 QKD 重筑防线', en: 'Quantum threat & post-quantum: Shor breaks public key; lattices and QKD rebuild the walls' },
