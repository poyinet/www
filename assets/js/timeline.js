...
window.CRYPTO_TIMELINE = [
  ...
  { y: 196, zh: '罗塞塔石碑出土', en: 'Rosetta Stone carved', icon: '🗿', link: { type: 'artifact', id: 'rosetta' } },
  ...
  { y: 1404, zh: '《密码之书》', en: 'Gabrieli\'s De Cifris', icon: '📕', link: { type: 'story', id: 'bacon' } },
  ...
  { y: 1641, zh: '《密码学》问世', en: 'Cryptomenytices Patefacta', icon: '📚', link: { type: 'story', id: 'bacon' } },
  ...
  { y: 1941, zh: '紫密被破 · 珍珠港', en: 'Purple broken · Pearl Harbor', icon: '🇯🇵', link: { type: 'story', id: 'purple' } },
  ...
  { y: 1953, zh: 'VENONA 曝光罗森伯格', en: 'VENONA exposes Rosenbergs', icon: '🕸️', link: { type: 'artifact', id: 'venona' } },
  ...
  { y: 1988, zh: 'Kryptos 雕塑揭幕', en: 'Kryptos sculpture unveiled', icon: '🗿', link: { type: 'artifact', id: 'kryptos' } },
  { y: 1991, zh: 'PGP 免费发布', en: 'PGP released free', icon: '📧', link: { type: 'story', id: 'modern' } },
  { y: 1994, zh: '量子密码实验', en: 'Quantum crypto experiments', icon: '⚛️', link: { type: 'term', id: 'Quantum Cryptography' } },
