...
维持一/二期全部否决项；新增：❌ 不做全站 CSS 死规则自动删除（历史理由「无可视回归安全网」；2026-08-24 复评更新：现有 visual 截图基线 + find-dead-css 工具 + check-css 结构门禁已构成安全网，实测全站死 CSS 仅 ~330B——结论维持「不删」，但性质从「不敢删」变为「无可删项」）· ❌ 不为单页 <10KB 收益增加加载分支 · ❌ 不引入框架级无障碍重构
